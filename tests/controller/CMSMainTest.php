...
class CMSMainTest extends FunctionalTest {
	...
	public function testPublish() {
		...
		$latestID = DB::preparedQuery('select max("Version") from "RedirectorPage_versions" where "RecordID" = ?', array($pageID))->value();
		$dsCount = DB::preparedQuery('select count("Version") from "RedirectorPage_versions" where "RecordID" = ? and "Version"= ?', array($pageID, $latestID))->value();
