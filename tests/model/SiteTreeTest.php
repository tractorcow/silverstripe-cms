...
class SiteTreeTest extends SapphireTest {
	...
	public function testCreatePermissions() {
		...
		$parent = $this->objFromFixture('Page', 'about');
		$this->assertFalse(singleton('SiteTree')->canCreate(null, $parent));
		...
		$this->assertFalse(singleton('SiteTreeTest_ClassA')->canCreate(null, $parentB));
		$this->assertTrue(singleton('SiteTreeTest_ClassC')->canCreate(null, $parentB));
	}
